...
from agent_os.core.models import Event, MemoryRecord, WorkspaceConfig
...
logger = logging.getLogger("agent_os.server.app")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="AgentOS Server API",
        description="REST and WebSocket control server for the AgentOS runtime.",
        version="0.1.0"
    )
