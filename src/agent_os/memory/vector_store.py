...
from agent_os.core.protocols import MemoryBackend

logger = logging.getLogger("agent_os.memory.vector")
...
class QdrantVectorStore:
    ...
    Requires `pip install agent-os[vectors]`.
    """
    def __init__(
        self, 
        collection_name: str = "agent_os_memories",
        location: str = ":memory:",
