...
from agent_os.core.protocols import ToolProtocol
from agent_os.tools.schema import generate_tool_schema
...
def tool(
    ...
    *,
    ...
    """
    @tool decorator to convert standard Python functions into AgentOS tools.
