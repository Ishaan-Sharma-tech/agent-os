...
from agent_os.core.models import Event, ToolCall
from agent_os.core.permissions import Capability, check_permission, AgentOSPermissionError
from agent_os.core.workspace import Workspace
from agent_os.tools.registry import tool_registry

logger = logging.getLogger("agent_os.tools.runtime")
...
class ToolExecutor:
    ...
    async def execute(self, tool_name: str, arguments: Dict[str, Any]) -> Any:
        ...
        if not check_permission(self.capabilities, required_cap):
            raise AgentOSPermissionError(required_cap, self.agent_name)
